...
const Footer = () => {
    return (
        <footer id="footer" className="w-full mt-20 bg-[#333333] pt-20 px-10 relative">
            ...
            <div className="footer-back absolute top-0 left-0 right-0 z-[0] h-full flex">
                <svg width="1440" height="301" viewBox="0 0 1440 301" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
