...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const invalidEmail = document.querySelectorAll(
      "#footer .email-validation small"
    )[1];
    const sendError = document.querySelectorAll(
      "#footer .email-validation small"
    )[2];
    const sendSuccess = document.querySelectorAll(
      "#footer .email-validation small"
    )[3];
    if (email == "") {
    ...
    if (emailRegex.test(email) && email !== "") {
      ...
      emailInput.current;
      axios
        .post(process.env.NEXT_PUBLIC_BASE_URL + "settings/newsletter/", {
          email: email,
        })
        .then((res) => {
          emailValidation.style.visibility = "visible";
  ...
  return (
    <footer
      id="footer"
      className="w-full mt-20 bg-[#333333] pt-20 px-10 relative"
    >
      <div className="footer-back absolute top-0 left-0 right-0 z-[0] hidden lg:flex h-full">
        <svg
          width="1440"
          height="301"
      ...
      <div className="container mx-auto flex flex-col relative z-10">
            ...
            <div className="footer-item h-full">
              <div className="footer-inner py-8 px-10 h-full">
                <div className="description flex items-center justify-center h-full">
                  <div className="logo">
                    {/* <Image src="/img/barjil-logo.png" alt="logo" width={50} height={50}/> */}
                    <LogoIcon fill="#fff" width="50" />
                  </div>
                  <div
                    className="footer-short-text text-[#fff] text-sm mx-4"
                    dangerouslySetInnerHTML={{
                      __html:
                        language == "en"
                          ? footerItem?.translations.en.footer_text
                          : language == "ar"
                          ? footerItem?.translations.ar.footer_text
                          : footerItem?.translations.ur.footer_text,
                    }}
                  ></div>
                </div>
              </div>
            ...
            <div className="footer-item h-full">
              <div className="footer-inner py-5 px-8 h-full">
                <div className="join-us flex flex-col items-center justify-center h-full">
                  <h2 className="title text-lg text-center text-white mb-3 peyda-bold">
                    {language == "en"
                    ...
                    <div className="input-g flex flex-wrap">
                      <div className="w-[80%]">
                        <input
                          ...
                          className="w-full h-full px-3 rounded-md bg-[#d2ffc14a] bg-opacity-25 outline-0 text-white text-base sm:text-sm md:text-base"
                          ref={emailInput}
                          onInput={(e) => {
                      ...
                      <div className="w-[20%] flex justify-center">
                        <button
                          type="submit"
                          className="flex items-center justify-center p-1 bg-transparent outline-0 border-2 border-white rounded-md"
                    ...
                    <div className="email-validation flex flex-col mt-2">
                      ...
                      <small className="hidden">
                        {language == "en"
                          ...
                          : "ای میل کامیابی کے ساتھ بھیج دی گئی ہے!"}
                      </small>
                    </div>
                  </form>
                </div>
          ...
          <div className="footer-item-wrapper md:row-start-1 md:row-end-3 md:col-start-2 md:col-end-3 order-2">
            <div className="footer-item h-full">
              <div className="footer-inner py-5 px-8 text-center h-full">
                <div className="quick-acces flex flex-col h-full">
                  <h2 className="title text-xl md:text-2xl text-white font-bold pb-4 border-b border-white border-opacity-45 cursor-default">
                    {language == "en"
                      ? "Quick acces"
                      : language == "ar"
                      ? "الوصول السريع"
                  ...
                  <div className="links mt-4 flex flex-col items-center">
                    <Link
                      ...
                      className="text-white text-opacity-60 mb-3 duration-300 hover:text-opacity-100 "
                    >
                      {language == "en"
                        ? "Home"
                        : language == "ar"
                    ...
                    <a
                      ...
                      className="text-white text-opacity-60 duration-300 hover:text-opacity-100 "
                    >
                      {language == "en"
                        ? "Articles"
                        : language == "ar"
          ...
          <div className="footer-item-wrapper md:row-start-1 md:row-end-3 md:col-start-3 md:col-end-4 order-3">
            <div className="footer-item h-full">
              <div className="footer-inner p-6 text-center h-full">
                <div className="useful-links flex flex-col h-full">
                  <h2 className="title text-xl md:text-2xl text-white font-bold pb-4 border-b border-white border-opacity-45 cursor-default">
                    {language == "en"
                      ? "Useful links"
                      : language == "ar"
        ...
        <div className="flex justify-center mt-6">
          <div className="developing bg-[#666666] text-[#252525] rounded-tl-[4px] rounded-tr-[4px] py-2 px-6 cursor-default duration-300 hover:text-white text-[12px] sm:text-[14px] md:text-base text-center">
            <Link href="https://www.rubysa.ir/">
              {language == "en"
                ? "Designed & Developed by Rubysa"
                : language == "ar"
                ? "تم التصميم والتطوير بواسطة Rubysa"
                : "Rubysa کے ذریعے ڈیزائن اور ڈیولپ کیا گیا"}
            </Link>
          </div>
        </div>
      </div>
