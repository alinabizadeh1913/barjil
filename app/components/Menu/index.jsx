...
const Menu = () => {
    return (
        <section id="menu" className={`${Font.className} absolute top-0 left-0 w-full z-10 backdrop-filter backdrop-blur-sm py-5 px-9 bg-[#33333333]`}>
            <div className="container mx-auto">
                <div className="flex flex-wrap items-center justify-between md:justify-normal">
                    ...
                    <div className="w-2/12 hidden md:order-4 md:flex justify-center justify-end ">
