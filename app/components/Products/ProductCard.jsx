    ...
    return (
        <div className="product-card rounded-lg p-3 flex items-center">
            <div className="card-image w-[50%] h-[230px] border-2 border-white rounded-md relative">
                <Image src={props.image || "/img/product-card.png"} alt={props.alt} className="rounded-md w-full h-full" fill style={{ objectFit: 'cover' }}/>
            </div>
            <div className={`card-content w-[50%] ${props.fit ? '' : 'h-full'} px-3 flex flex-col justify-between`}>
