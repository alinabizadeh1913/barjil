            ...
            <div className={`${props.hasContainer === 'true' ? 'wrapper mx-auto' : 'w-full'} flex flex-col items-center`}>
                <div className="title md:w-[79%] px-6 md:p-0">
                    ...
                    <p className="text-[#707070] flex justify-center md:justify-start">
                        ...
                        <svg width="66" height="127" viewBox="0 0 96 157" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-full flex flex-wrap items-center md:mt-[-115px]">
                    <div className="w-full md:w-7/12">
                        <div className="form-wrapper overflow-hidden">
                            ...
                            <form action="" className="flex items-center w-full">
                                <div className="circle-wrapper hidden md:flex relative justify-center items-center">
                    ...
                    <div className="w-full md:w-5/12 px-4">
                        <div className="image relative flex justify-end overflow-hidden">
